...
//-----------------------------------------------------------------------------------------------------------
/*!	\file model/vector2stream.h
	\brief Definition von x::model::Vector2Stream
	\version 0.1
	\date 21.9.2003
	\author Christian Oberholzer

	Definition von x::model::Vector2Stream
*/
//-----------------------------------------------------------------------------------------------------------
#ifndef MODEL_VECTOR2STREAM_H
#define MODEL_VECTOR2STREAM_H
...
/*!
*/
class Vector2Stream : public Stream
{
public:
	Vector2Stream();
	virtual ~Vector2Stream();

	// Daten setzen
	virtual void SetSemantics(const SemanticTypes semantics);
	virtual void SetSemanticsInfo(const uint_t semantics_info);
	virtual void SetData(const uint_t element_count, math::Vector2f* data);

	// Informationen über den Vector2Stream
...
protected:
	...
	math::Vector2f* array_;
	bool_t is_dirty_;
};

}} // namespace x::model

#endif // MODEL_VECTOR2STREAM_H
