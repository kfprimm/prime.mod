...
Type TMatrix
	...
	Function Project(modelview:TMatrix, projection:TMatrix, viewport[], x# Var, y# Var, z# Var)
		Local w#=1.0
		modelview.Multiply(projection).TransformVec4 x,y,z,w
		If w=0 Return False
		x:/w;y:/w;z:/w
	...
	Function Unproject(modelview:TMatrix, projection:TMatrix, viewport[], wx#, wy#, wz#, x# Var, y# Var, z# Var)
		x=((wx-viewport[0])/viewport[2])*2 - 1
		y=((wy-viewport[1])/viewport[3])*2 - 1
		z=wz*2-1
		Local w#=1.0
		modelview.Multiply(projection).Inverse().TransformVec4 x,y,z,w
		If w=0 Return False
		x:/w;y:/w;z:/w
		Return True
	End Function
