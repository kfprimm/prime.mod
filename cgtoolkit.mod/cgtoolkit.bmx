...
Extern
	...
	Function cgCreateProgram(context, program_type, program:Byte Ptr, profile, entry:Byte Ptr, args:Byte Ptr Ptr)
	'Function cgCreateProgramFromFile(context, CGenum program_type, const char *program_file, profile, const char *entry, const char **args)
	Function cgCopyProgram(program)
	Function cgDestroyProgram(program)
	Function cgGetFirstProgram(context)
	Function cgGetNextProgram(currnt)
	Function cgGetProgramContext(program)
	...
	'Function cgSetProgramProfile(program, profile)
	...
	Function cgGetNamedParameter(program, name:Byte Ptr)
	'Function cgGetNamedProgramParameter(program, CGenum name_space, const char *name)
	Function cgGetFirstParameter(program, name_space)
	Function cgGetNextParameter(curr_param)
	...
	Function cgGetNamedStructParameter(param, name$z)
	...
	Function cgGetParameterContext(param)
	Function cgIsParameter(param)
	Function cgGetParameterName:Byte Ptr(param)
	Function cgGetParameterType(param)
	Function cgGetParameterBaseType(param)
	Function cgGetParameterClass(param)
	Function cgGetParameterRows(param)
	Function cgGetParameterColumns(param)
	Function cgGetParameterNamedType(param)
	...
	Function cgGetTypeString$z(type_)
	...
	'CG_API const char * CGENTRY cgGetProfileString(profile)
	...
	'Function cgIsProfileSupported(profile)
	'Function cgGetProfileProperty(profile, CGenum query)
	...
	Function cgGetError()
	Function cgGetFirstError()
	Function cgGetErrorString:Byte Ptr(error)
	Function cgGetLastErrorString:Byte Ptr(error:Int Ptr)
	...
	'Function cgCreateProgramFromEffect(CGeffect effect, profile, const char *entry, const char **args)
	...
	'Function cgSetStateLatestProfile(CGstate state, profile)
	...
	'CG_API CGdomain CGENTRY cgGetProfileDomain(profile)
	...
	'CG_API CGobj CGENTRY cgCreateObj(context, CGenum program_type, const char *source, profile, const char **args)
	'CG_API CGobj CGENTRY cgCreateObjFromFile(context, CGenum program_type, const char *source_file, profile, const char **args)
	...
	'Function cgGetProgramBufferMaxSize(profile)
	'Function cgGetProgramBufferMaxIndex(profile)
