...
//-----------------------------------------------------------------------------------------------------------
/*!	\file templates/vector.h
	\brief Definition von x::templates::Vector
	\version 0.1
	\date 21.9.2003
	\author Christian Oberholzer

	Definition von x::templates::Vector
*/
//-----------------------------------------------------------------------------------------------------------
...
/*!
	...
	Implementiert das X-File-Vector-Template.
*/
class Vector : public Template
{
public:
	//-------------------------------------------------------------------------------------------------------
...
public:
	...
	//-------------------------------------------------------------------------------------------------------
	virtual const math::Vector3f& GetVector() const;
