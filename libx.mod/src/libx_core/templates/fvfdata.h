...
//-----------------------------------------------------------------------------------------------------------
/*!	\file templates/fvfdata.h
	\brief Definition von x::templates::FVFData
	\version 0.1
	\date 21.9.2003
	\author Christian Oberholzer

	Definition von x::templates::FVFData
*/
//-----------------------------------------------------------------------------------------------------------
#ifndef TEMPLATES_FVFDATA_H
#define TEMPLATES_FVFDATA_H
...
//-----------------------------------------------------------------------------------------------------------
/*!
	\brief FVFData-Template
	\version 0.1
	\date 2.4.2004
	\author Christian Oberholzer

	Implementiert das X-File-FVFData-Template.
*/
class FVFData : public Template
{
public:
	//-------------------------------------------------------------------------------------------------------
